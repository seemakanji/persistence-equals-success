      ...
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 grid md:grid-cols-2 items-center gap-10">
        <div>
          ...
          <p className="mt-6 text-slate-700">
            ...
            and the long road through infertility, adoption, and surrogacy to a family formed by love.
          </p>
    ...
    <section id="about" className="scroll-mt-16">
      <div className="mx-auto max-w-6xl px-4 py-16">
        ...
        <p className="mt-4 text-slate-700 leading-relaxed">
          ...
          was an eight-year struggle with infertility, four failed IVF cycles, and heartbreak in
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-4 leading-relaxed text-slate-700">
            Seema is a lawyer, licensed insurance agent, and now author based in Canada. She brings legal
            rigor and deep empathy to her storytelling, illuminating how persistence—through cultural
            pressure, infertility, international surrogacy, and adoption—shaped a resilient family and a
            purposeful career.
          </p>
          <div className="mt-6 grid grid-cols-2 gap-4">
            <Fact label="Profession" value="Lawyer · Insurance Agent · Author" />
            <Fact label="Education" value="UBC Law (1998); admitted to UVic and UBC" />
    ...
    <section id="contact" className="scroll-mt-16">
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6 text-left">
          <ContactCard title="Speaking & Media" body="Invite Seema for interviews, podcasts, or panels on law, resilience, and routes to motherhood." />
